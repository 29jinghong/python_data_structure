...
cur.execute('''SELECT COUNT(from_id) AS inbound, old_rank, new_rank, id, url 
    ...
    #looking at the highest number of inbound links
...
#looking for hignest and lowes rank
...
for row in nodes :
    ...
    #all writing about how the ball looks in the visual part for example how big it is
    map[row[3]] = count
    ranks[row[3]] = rank
    count = count + 1
fhand.write('],\n')
